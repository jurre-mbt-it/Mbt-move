/**
 * Stand-alone pijnrapport (NRS 0-10 + locatie + context).
 *
 * Gedeeld tussen de patiënt- en atleet-shell: `homeHref` bepaalt waar de
 * "terug naar home"-knop na bevestiging heen gaat.
 */
'use client'
...
export function PainReportForm({ homeHref }: { homeHref: string }) {
