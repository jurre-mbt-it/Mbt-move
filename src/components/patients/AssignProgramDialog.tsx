        ...
        {step === 'code' && selectedProgram && (
          <>
            ...
            <div className="space-y-4 mt-2 text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto" style={{ background: 'rgba(232,122,85,0.14)' }}>
                <CheckCircle2 className="w-8 h-8" style={{ color: '#e87a55' }} />
              </div>
              <div>
              ...
              <Button className="w-full" style={{ background: '#e87a55' }} onClick={handleClose}>
                Sluiten
              </Button>
            </div>
          </>
