...
/**
 * Atleet: Apple-Watch-overzicht — readiness, slaap, vitals en activiteiten
 * uit de HealthKit-sync. Zelfde paneel als de patiënt-shell en het
...
export default function AthleteWearablesPage() {
